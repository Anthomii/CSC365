...
grant all on winter2019.hp_goods to hasty@'%';
grant all on winter2019.hp_customers to hasty@'%';
grant all on winter2019.hp_items to hasty@'%';
grant all on winter2019.hp_receipts to hasty@'%';

-- Shell init:
export CLASSPATH=$CLASSPATH:mysql-connector-java-5.1.44-bin.jar:.
export HP_JDBC_URL=jdbc:mysql://db.labthreesixfive.com/winter2019?autoReconnect=true\&useSSL=false
export HP_JDBC_USER=
export HP_JDBC_PW=
 */
